...
class CurrencySkill {
  public get = async(req: Request, res: Response) => {
    ...
    const arrMataUang = ["Euro", "Dolar Singapura", "Dolar Australia", "Dolar Hong Kong", "Dolar Kanada", "Dolar", "Ringgit", "Poundsterling", "Yuan", "Renmibi", "Lira", "Peso Meksiko", "Yen", "Won", "Riyal", "Dirham", "rupee", "Rufiyaa", "Baht", "Peso", "Forint", "Franc"];
    // const arrNegara = ["Eropa", "Singapura", "Australia", "Hong Kong", "Kanada", "Amerika Serikat", "Malaysia", "Inggris", "China", "China", "Italia", "Meksiko", "Jepang", "Korea", "Saudi Arabia", "Arab", "India", "Maladewa (Maldives)", "Thailand", "Filipina", "Hungary", "Swiss"]; 
    const arrKode = ["EUR","SGD","AUD","HKD","CAD","USD","MYR","GBP","CNY","CNH","ITL","MXN","JPY","KRW","SAR","AED","INR","MVR","THB","PHP","HUF","CHF"];
